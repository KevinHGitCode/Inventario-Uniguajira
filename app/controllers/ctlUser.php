 ...
 * 
 * Este método verifica la validez del ID del usuario y lo elimina si es posible.
 * El usuario con ID 1 no puede ser eliminado (por seguridad del sistema).
 */
...
//     // Condición especial: No permitir eliminar al usuario con ID = 1 (superadmin)
//     if ($id === 1) {
//         http_response_code(403); // Forbidden
//         echo json_encode(['success' => false, 'message' => 'El usuario administrador principal no puede ser eliminado']);
//         return;
//     }
    
    
//         // Llamar al modelo para eliminar el usuario
//         $resultado = $this->userModel->deleteUser((int)$id);
...
public function deleteUser($id) {
    ...
    try {
        // Verificamos que sea método DELETE
